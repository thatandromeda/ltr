...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Script.name'
        db.add_column(u'ltr_script', 'name',
                      self.gf('django.db.models.fields.CharField')(default='b', max_length=50),
                      keep_default=False)

        # Adding field 'Questionnaire.name'
        db.add_column(u'ltr_questionnaire', 'name',
                      self.gf('django.db.models.fields.CharField')(default='b', max_length=50),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Script.name'
        db.delete_column(u'ltr_script', 'name')

        # Deleting field 'Questionnaire.name'
        db.delete_column(u'ltr_questionnaire', 'name')
